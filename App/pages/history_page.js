...
import { FlatList, StyleSheet, Text, View, Image, TouchableHighlight, Button, Dimensions, ActivityIndicator, Alert } from 'react-native';
...
export default class HistoryPage extends React.Component {
    ...
    render() {
        ...
        if (db.state.loading) {//!db.state.loading) {
        ...
        return (
            ...
            >
                    ...
                    <View>
                        <View style={styles.button_modal}><Button color='black' title="DELETE" onPress={this.toggleModal} /></View>
                    </View>
                </View>
            ...
            >
                <View style={{
                    ...
                    <View style={{ ...styles.button_modal, marginTop: -20 }}><Button color='black' title="DELETE" onPress={() => 
                    {this.setState({ isModalVisible2: false }) 
                    this.database.splice(this.state.index, 1)}} /></View>
                    <View style={{ ...styles.button_modal, marginTop: -20,backgroundColor: 'white', }}><Button color='black' title="CANCEL" onPress={() => 
                    {this.setState({ isModalVisible2: false }) 
                    }} /></View>
                </View>
